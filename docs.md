# Legge Costituzionale di Riforma della Giustizia — Knowledge Base

## Istruzioni per l'assistente

Questo documento contiene informazioni sulla legge costituzionale pubblicata in Gazzetta Ufficiale n. 253 del 30 ottobre 2025, recante "Norme in materia di ordinamento giurisdizionale e di istituzione della Corte disciplinare".

Nel linguaggio colloquiale e giornalistico è comunemente conosciuta anche come:

- Riforma della giustizia
- Riforma della magistratura
- Separazione delle carriere (in riferimento alla separazione delle carriere dei magistrati tra requirenti e giudicanti)

Come riporta l'avvertenza all'inizio del testo della legge pubblicato in Gazzetta Ufficiale:
...
Si procederà quindi a un referendum popolare confermativo, indetto per domenica 22 e lunedì 23 marzo 2026, che verterà sul seguente quesito:

```
Approvate il testo della legge costituzionale concernente "Norme in materia di ordinamento giurisdizionale e di istituzione della Corte disciplinare" approvato dal Parlamento e pubblicato nella Gazzetta Ufficiale
...
- Spiega il ragionamento che ti ha portato a una data conclusione.
- Se la domanda non è chiara o può dare adito ad ambiguità, chiedi un chiarimento all'utente.
- Se l'utente chiede il testo integrale della legge, indica queste fonti:
  - https://raw.githubusercontent.com/ndrbrt/riforma-costituzionale-giustizia/refs/heads/master/full-text.txt
  - https://www.gazzettaufficiale.it/eli/id/2025/10/30/25A05968/sg
  - https://www.gazzettaufficiale.it/eli/gu/2025/10/30/253/sg/pdf (alle pagine "2" e "3" del documento contenuto, corrispondenti alle pagine 6 e 7 del file pdf)
- Rispondi in italiano, a meno che l'utente non scriva in un'altra lingua.
- Quando citi un articolo, riporta il testo esatto dal documento.
- Se l'utente chiede differenze tra vecchio e nuovo testo, usa i diff forniti.

## Articoli nella versione precedente alla riforma

### Articolo 87 (testo precedente alla riforma)
...
### Articolo 102 (testo precedente alla riforma)
...
### Articolo 104 (testo precedente alla riforma)
...
### Articolo 105 (testo precedente alla riforma)
...
### Articolo 106 (testo precedente alla riforma)
...
### Articolo 107 (testo precedente alla riforma)

```
Art. 107

I magistrati sono inamovibili. Non possono essere dispensati o sospesi dal servizio né destinati ad altre sedi o funzionari se non in seguito a decisione del Consiglio superiore della magistratura, adottata o per i motivi e con le garanzie di difesa stabilite dall'ordinamento giudiziario o con il loro consenso.
Il Ministro della giustizia ha facoltà di promuovere l'azione disciplinare.
I magistrati si distinguono fra loro soltanto per diversità di funzioni.
Il pubblico ministero gode delle garanzie stabilite nei suoi riguardi dalle norme sull'ordinamento giudiziario.
```

### Articolo 110 (testo precedente alla riforma)
...
## Articoli nella versione aggiornata dalla riforma

### Articolo 87 (testo aggiornato dalla riforma)
...
### Articolo 102 (testo aggiornato dalla riforma)
...
### Articolo 104 (testo aggiornato dalla riforma)
...
### Articolo 105 (testo aggiornato dalla riforma)
...
### Articolo 106 (testo aggiornato dalla riforma)
...
### Articolo 107 (testo aggiornato dalla riforma)

```
Art. 107

I magistrati sono inamovibili. Non possono essere dispensati o sospesi dal servizio né destinati ad altre sedi o funzionari se non in seguito a decisione del rispettivo Consiglio superiore della magistratura, adottata o per i motivi e con le garanzie di difesa stabilite dall'ordinamento giudiziario o con il loro consenso.
Il Ministro della giustizia ha facoltà di promuovere l'azione disciplinare.
I magistrati si distinguono fra loro soltanto per diversità di funzioni.
Il pubblico ministero gode delle garanzie stabilite nei suoi riguardi dalle norme sull'ordinamento giudiziario.
```

### Articolo 110 (testo aggiornato dalla riforma)
...
```diff
--- articles/102/old.txt
+++ articles/102/new.txt
@@ -1,5 +1,5 @@
 Art. 102
...
```diff
--- articles/104/old.txt
+++ articles/104/new.txt
@@ -1,9 +1,9 @@
 Art. 104
...
```diff
--- articles/105/old.txt
+++ articles/105/new.txt
@@ -1,3 +1,10 @@
 Art. 105
...
```diff
--- articles/106/old.txt
+++ articles/106/new.txt
@@ -2,4 +2,4 @@
...
```diff
--- articles/107/old.txt
+++ articles/107/new.txt
@@ -1,6 +1,6 @@
 Art. 107
...
```diff
--- articles/110/old.txt
+++ articles/110/new.txt
@@ -1,3 +1,3 @@
 Art. 110
...
- [https://www.gazzettaufficiale.it/eli/id/2025/10/30/25A05968/sg](https://www.gazzettaufficiale.it/eli/id/2025/10/30/25A05968/sg)
- [https://www.gazzettaufficiale.it/eli/gu/2025/10/30/253/sg/pdf](https://www.gazzettaufficiale.it/eli/gu/2025/10/30/253/sg/pdf)
- [https://www.programmagoverno.gov.it/it/approfondimenti/riforme-di-rilievo-del-governo/riforme-di-rilievo-del-governo/riforme-costituzionali/riforma-della-magistratura/](https://www.programmagoverno.gov.it/it/approfondimenti/riforme-di-rilievo-del-governo/riforme-di-rilievo-del-governo/riforme-costituzionali/riforma-della-magistratura/)
- [https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione](https://www.normattiva.it/uri-res/N2Ls?urn:nir:stato:costituzione)
- [https://prefettura.interno.gov.it/it/referendum-costituzionale-22-e-23-marzo-2026](https://prefettura.interno.gov.it/it/referendum-costituzionale-22-e-23-marzo-2026)
- [https://www.gazzettaufficiale.it/eli/id/2026/01/14/26A00167/sg](https://www.gazzettaufficiale.it/eli/id/2026/01/14/26A00167/sg)
- [https://www.gazzettaufficiale.it/eli/gu/2026/01/14/10/sg/pdf](https://www.gazzettaufficiale.it/eli/gu/2026/01/14/10/sg/pdf)
